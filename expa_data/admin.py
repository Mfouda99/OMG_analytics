...
@admin.register(PodioSignupOGV)
class PodioSignupOGVAdmin(admin.ModelAdmin):
    list_display = ('podio_item_id', 'first_name', 'last_name', 'home_lc', 'ep_id', 'created_at', 'sync_date')
    list_filter = ('home_lc', 'created_at', 'sync_date')
    search_fields = ('first_name', 'last_name', 'ep_id', 'podio_item_id')
    readonly_fields = ('podio_item_id', 'created_at', 'sync_date')
    list_per_page = 50
    date_hierarchy = 'created_at'
    
    fieldsets = (
        ('Basic Info', {
            'fields': ('podio_item_id', 'first_name', 'last_name', 'created_at')
        }),
        ('AIESEC Details', {
            'fields': ('home_lc', 'ep_id')
        }),
        ('System Info', {
            'fields': ('sync_date',)
        })
...
@admin.register(PodioSignupOGTa)
class PodioSignupOGTaAdmin(admin.ModelAdmin):
    list_display = ('podio_item_id', 'first_name', 'last_name', 'home_lc', 'ep_id', 'created_at', 'sync_date')
    list_filter = ('home_lc', 'created_at', 'sync_date')
    search_fields = ('first_name', 'last_name', 'ep_id', 'podio_item_id')
    readonly_fields = ('podio_item_id', 'created_at', 'sync_date')
...
@admin.register(PodioSignupOGTe)
class PodioSignupOGTeAdmin(admin.ModelAdmin):
    list_display = ('podio_item_id', 'first_name', 'last_name', 'home_lc', 'ep_id', 'created_at', 'sync_date')
    list_filter = ('home_lc', 'created_at', 'sync_date')
    search_fields = ('first_name', 'last_name', 'ep_id', 'podio_item_id')
    readonly_fields = ('podio_item_id', 'created_at', 'sync_date')
